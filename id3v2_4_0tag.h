#ifndef APOLLO_ID3V2_4_0TAG_H
#define APOLLO_ID3V2_4_0TAG_H

#include "id3v2tag.h"

namespace Apollo {

class ID3v2_4_0Tag : public Apollo::ID3v2Tag
{
public:
    ID3v2_4_0Tag(unsigned char flags, std::vector<unsigned char> & data);
